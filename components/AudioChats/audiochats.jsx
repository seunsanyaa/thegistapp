...
export default function AudioCharts( ) {
    ...
    return (
        ...
        <div className={audiostyles.containerOutside}>
...
<div className={audiostyles.bigImageContainer}>
